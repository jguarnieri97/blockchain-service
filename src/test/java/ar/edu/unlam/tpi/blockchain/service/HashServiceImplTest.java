...
class HashServiceImplTest {
    ...
    @Test
    @DisplayName("Should calculate correct SHA-256 hash for input data")
    ...
    @Test
    @DisplayName("Should return success message when hashes match")
    ...
    @Test
    @DisplayName("Should handle empty input data for hash calculation")
    ...
    @Test
    @DisplayName("Should handle null input data for hash calculation")
